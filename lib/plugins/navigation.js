...
var NavigationUI = {
    ...
    init: function(id, fieldId, recordId, storage, element){
        ...
        this.currentRecord = typeof rec === 'object' ? rec : this.currentRecord;
                        ...
                        <div class="col-md-12 column"> \
                            <div class="form-group"> \
                                <select class="form-control cmsinn-nav-page-type"> \
                                    ...
                                    '+this.buildOptions(CmsInnNavigation.pageTypes, this.currentRecord.template)+' \
                                </select> \
                            </div> \
                        </div> \
                    </div> \
                        ...
                        <div class="col-md-12 column"> \
                            <div class="form-group"> \
                                <div class="input-group"> \
                                    ...
                                    <input type="text" class="form-control cmsinn-nav-item-uri" value="'+this.currentRecord.uri+'"> \
                                </div> \
                            </div> \
                        </div> \
                    </div> \
...
Navigation.prototype.getRecord = function(navId){
...
Navigation.prototype.getRecordField = function(recordId, field){
    ...
    var record = this.storage.collection.findOne({_id:recordId}, select);
